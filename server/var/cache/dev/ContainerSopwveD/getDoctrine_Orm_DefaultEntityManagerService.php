...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CampingHouseRepository' => function () {
    return ($this->privates['App\Repository\CampingHouseRepository'] ?? $this->load('getCampingHouseRepositoryService.php'));
