...
// Returns the private 'App\Repository\CampingHouseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CampingHouseRepository.php';

return $this->privates['App\Repository\CampingHouseRepository'] = new \App\Repository\CampingHouseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
