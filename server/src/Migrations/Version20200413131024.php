 ...
 */
final class Version20200413131024 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservations_cottages (reservations_id INT NOT NULL, cottages_id INT NOT NULL, INDEX IDX_A43B78E3D9A7F869 (reservations_id), INDEX IDX_A43B78E38E608045 (cottages_id), PRIMARY KEY(reservations_id, cottages_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE reservations ADD event_id INT NOT NULL, ADD guest_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD guest_last_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD guests_number INT DEFAULT NULL, ADD payment_on_account TINYINT(1) NOT NULL, ADD is_active TINYINT(1) NOT NULL, ADD phone_number VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
